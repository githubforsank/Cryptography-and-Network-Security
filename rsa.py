...
if __name__=='__main__':
    ...
    print ('\ne = {0}'.format(e))
    print ('\nd = {0}\n'.format(d))
    message = raw_input("Enter a plain text data :")
    print "\n\n\nOriginal Message :",(message)
    cipher = encrypt(message, n, e, 2)
    print "Encrypted Message :",(cipher)
    Amessage = decrypt(cipher, n, d, 2)
    print "Decrypted Message :" ,(Amessage)
    with open("abc.jpeg", "rb") as imageFile:
        str = base64.b64encode(imageFile.read())
        #print str
    size_str=len(str)
    print "Now encrypting the image string "
    cipher = encrypt(str, n, e, 2)
    print "Encrypted Message :",(cipher)
    webbrowser.open('abc.jpeg')
    Amessage = decrypt(cipher, n, d, 2)
    Amessage=Amessage[:size_str]
    imgdata = base64.b64decode(Amessage)
    filename = 'decrypted.jpeg' 
